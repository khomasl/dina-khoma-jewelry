...
const AboutSection: FC<Props> = ({section}) => {
  return (
    ...
    >
      ...
      <div className={clsx("row-start-1 lg:col-start-2 px-10 lg:pr-0 lg:pl-20 pb-10 lg:pb-0", manrope.className)}>
        ...
        <div className="flex gap-5 justify-between mb-8">
          {section.items.map(item => (
            <div className="flex gap-2 md:gap-4 items-center">
              <span className="text-2xl md:text-4xl font-bold">{item.title}</span>
