...
const AboutSection: FC<Props> = ({section}) => {
  return (
    ...
    >
      <div className="px-5 lg:px-0 pb-10 lg:pb-0">
      ...
      <div className={clsx("row-start-1 lg:col-start-2 px-5 lg:px-0 lg:ml-16 pb-10 lg:pb-0", manrope.className)}>
        <div className="text-violet-400 font-bold text-center lg:text-left">{section.header}</div>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 mt-2 max-w-2/3 lg:px-0 text-center lg:text-left">{section.title}</h2>
