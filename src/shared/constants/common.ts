...
const BASE_URL = "https://shop.dinakhoma.com";
...
const METADATA = {
  ...
  description:
    "Купити пташки. Пташки з петриківським розписом. Біла пташка. Пташка з малюнком. Чокери. Кольє. Полімерна глина. Перли. Фурнітура. Ручна робота. Вироби за індивідуальним замовленням. Доставка по Україні.",
...
const CURRENT_COLLECTIONS = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Пташка з полімерної глини, перлини річкові, фурнітура з позолотою",
      price: "850 грн",
    ...
    },
    {
      ...
      description:
        "Пташка з полімерної глини, ручний петриківський розпис, скляні намистини, бронзова фурнітура",
      price: "520 грн",
    ...
    },
    {
      ...
      description:
        "Пташка з полімерної глини, ручний розпис, шнурочок з екозамші 150 см",
      price: "380 грн",
...
const OTHER_COLLECTIONS = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Пташка з полімерної глини, ручний розпис, ланцюжок з позолотою",
      price: "530 грн",
    ...
    },
    {
      ...
      description:
        "Підвіска з полімерної глини, ручний розпис, оксамитова стрічка 150 см, фурнітура з позолотою",
      price: "650 грн",
    ...
    },
    {
      ...
      description:
        "Ягідки з полімерної глини, скляні намистини, нержавіюча сталь",
      price: "680 грн",
...
const CONTENT_HOMEPAGE = {
  ...
  footer: {
    ...
    promo: {
      ...
      description:
        "Відправте промокод в один із месенджерів і отримайте знижку на своє перше замовлення",
      code: "prm-dina-15",
    },
  },
} as const;
...
const CONTENT_ABOUT = [
  {
    ...
    description:
      "Більше 10 років досвіду. Використовую тільки якісні матеріали.",
    button: {
